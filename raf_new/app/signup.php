    ...
    <div class="white-box">
      <form name="signupForm" class="form-horizontal form-material animated bounceIn" id="loginform" ng-submit="signUp(user)" method="POST">
        ...
        <div class="form-group text-center m-t-20">
          <div class="col-xs-12">
            <button ng-disabled="signupForm.$invalid || user.acceptTAC != true || loading == true" class="btn btn-primary btn-lg btn-block text-uppercase waves-effect waves-light" type="submit">
            <span ng-hide="loading == true" >Sign Up</span>
